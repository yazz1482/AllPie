...
def build_geometry(self):
    ...
    for i in range(
        ...
        separator_verts.extend((
            verts[0],
            verts[1]
        ))

    self.separator_batch = batch_for_shader(
...
def draw_menu(self):
    ...
    slice_color = self.slice_colors[
        self.space
    ]

    active_slice_color = self.active_slice_colors[
        self.space
    ]
    ...
    self.separator_shader.uniform_float(
        "color",
        separator_color
    )
    ...
    active_font_color = self.active_font_colors[
        self.space
    ]
...
class ModalRadialMenu(bpy.types.Operator):
    ...
    def invoke(
        ...
        self.separator_shader = gpu.shader.from_builtin(
            "UNIFORM_COLOR"
        )
