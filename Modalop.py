...
def INVOKE(label, operator, **props):
...
BRUSH_MENU = [
    OP("DRAW\nSHARP", "brush.asset_activate", asset_library_type="ESSENTIALS", relative_asset_identifier=Drawsharp),
    ...
    OP("CLAY\nSTRIPS", "brush.asset_activate", asset_library_type="ESSENTIALS", relative_asset_identifier=Clay),
]


BRUSH_SPACE_MENU = [
    OP("CREASE\nSHARP", "brush.asset_activate", asset_library_type="ESSENTIALS", relative_asset_identifier=Creasesharp),
    INVOKE("ASSET\nSHELF", "wm.call_asset_shelf_popover", name="VIEW3D_AST_brush_sculpt"),
    OP("SNAKE\nHOOK", "brush.asset_activate", asset_library_type="ESSENTIALS", relative_asset_identifier=Snakehook),
    OP("FACESET", "brush.asset_activate", asset_library_type="ESSENTIALS", relative_asset_identifier=Faceset),
    OP("TRIM", "brush.asset_activate", asset_library_type="ESSENTIALS", relative_asset_identifier=Trim),
    OP("MASK", "brush.asset_activate", asset_library_type="ESSENTIALS", relative_asset_identifier=Mask),
]


REMESH_MENU = [
    INVOKE("SET VOXEL\nSIZE", "object.voxel_size_edit"),
    INVOKE("REMESH\nMenu", "wm.call_panel", name="VIEW3D_PT_sculpt_voxel_remesh"),
    INVOKE("QUADRIFLOW\nREMESH", "cop.customquadriflow"),
    OP("+ VOXEL\n SIZE", "cop.cremesh", action="IncreaseVoxelSize25"),
    INVOKE("REMESH", "object.voxel_remesh"),
    OP("- VOXEL\n SIZE", "cop.cremesh", action="DecreaseVoxelSize25"),
]
...
SPACE_MENUS = {
    "EDGE": EDGE_SPACE_MENU,
    "BRUSH": BRUSH_SPACE_MENU,
}
